...
public class JdbcSaleRepository extends AbstractJdbcRepository<Sale, UUID> {
  ...
  private static final String SQL_SELECT_BY_ID = SQL_BASE_SELECT + "WHERE s.sale_id = ?";

  private static final String SQL_SELECT_ALL = SQL_BASE_SELECT + "ORDER BY s.sale_date DESC";
   ...
   *
   * <p>Client може бути null (анонімна покупка) — використовуємо LEFT JOIN та перевіряємо client_id
   * на null.
   */
  @Override
