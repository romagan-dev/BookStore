...
public class ConnectionManager implements AutoCloseable{
    ...
    /**
     * Повертає єдиний екземпляр ConnectionManager (Double-checked locking
     * Singleton)
     *
     ...
     *
     * <p> Клієнтський код зобов'язаний викликати {@code close()}
     * через try-with-resources. Реального
     ...
     *
     * @return рядок з кількістю вільних, зайнятих та максимальною
     * кількістю з'єднань
     */
